...
## Unreleased — кандидат 1.3.0

Версия ещё не выпущена: `VERSION`, скрипт и RPM spec остаются 1.2.4 до завершения полевой проверки и отдельного решения о выпуске. Подробный проверяемый список: `docs/releases/v1.3.0.md`.
