...
- [ ] README, CHANGELOG, `docs/USAGE.md`, `docs/AUTOMATION.md`, `docs/ENTERPRISE_PROFILES.md`, `docs/SCORING.md`, `docs/TECHNICAL.md`, `docs/TESTING.md`, release notes и пример отчёта соответствуют текущему поведению.
...
- [ ] Runtime smoke-test выполнен на доступных целевых РЕД ОС; для 1.2.3 отдельно проверены storage/removable, 802.1X, стабильность системы и copy-safe команды.
